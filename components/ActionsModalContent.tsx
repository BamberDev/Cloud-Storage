...
const ImageThumbnail = memo(({ file }: { file: Models.Document }) => (
...
export const FileDetails = memo(({ file }: { file: Models.Document }) => {
  return (
    <>
...
export const ShareFile = memo(
  ({ file, email, onEmailChange, onRemove }: ShareFileProps) => {
...
ShareFile.displayName = "ShareFile";
